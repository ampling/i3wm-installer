...
# DEFAULTS:
[ -z ${dotfilesrepo+x} ] && dotfilesrepo="https://github.com/lobsterdinnerparty/i3wm.git"
[ -z ${progsfile+x} ] && progsfile="https://raw.githubusercontent.com/lobsterdinnerparty/i3wm-installer/master/progs.csv"
